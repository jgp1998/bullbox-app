...
vi.mock('./PlateBreakdown', () => ({
    default: ({ totalWeight }: any) => <div data-testid="plate-breakdown">Breakdown for {totalWeight}</div>
}));
...
describe('WeightConverter', () => {
    ...
    it('renders with appropriate initial state and elements', () => {
        ...
        expect(screen.getByTestId('input-workoutForm.barWeight')).toBeInTheDocument();
