...
describe('useRecordsStore', () => {
  ...
  it('should update records and loading state', () => {
    ...
    const mockRecords: WorkoutRecord[] = [
      { id: '1', date: '2023-01-01', exercise: 'Squat', weight: 100, reps: 5, unit: 'kg' }
    ];
  ...
  describe('getPersonalBests', () => {
    ...
    it('should correctly identify personal bests for different exercises', () => {
      ...
      const mockRecords: WorkoutRecord[] = [
        { id: '1', date: '2023-01-01', exercise: 'Squat', weight: 100, reps: 5, unit: 'kg' },
        { id: '2', date: '2023-01-05', exercise: 'Squat', weight: 110, reps: 5, unit: 'kg' }, // New best
        { id: '3', date: '2023-01-02', exercise: 'Bench', weight: 80, reps: 5, unit: 'kg' }
      ];
    ...
    it('should compare 1RM for weight-based exercises', () => {
      const store = useRecordsStore.getState();
      const mockRecords: WorkoutRecord[] = [
        { id: '1', date: '2023-01-01', exercise: 'Squat', weight: 100, reps: 10, unit: 'kg' }, // 1RM ~133
        { id: '2', date: '2023-01-05', exercise: 'Squat', weight: 120, reps: 2, unit: 'kg' }   // 1RM ~128
      ];
    ...
    it('should handle different weight units by converting to kg for comparison', () => {
      ...
      const mockRecords: WorkoutRecord[] = [
        { id: '1', date: '2023-01-01', exercise: 'Squat', weight: 100, reps: 1, unit: 'kg' },
        { id: '2', date: '2023-01-05', exercise: 'Squat', weight: 210, reps: 1, unit: 'lbs' }
      ];
