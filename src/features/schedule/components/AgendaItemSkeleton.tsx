...
const AgendaItemSkeleton: React.FC = () => {
    return (
        <div className="flex items-center p-4 bg-(--input)/50 rounded-2xl border border-(--border)/30 opacity-60">
            {/* Date/Time badge placeholder */}
            <div className="w-12 h-12 rounded-xl bg-(--card) flex flex-col items-center justify-center border border-(--border) shrink-0 mr-4">
